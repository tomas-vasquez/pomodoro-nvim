...
local pomodoro_settings = {
	work_duration = 0.25, -- Duración del trabajo en minutos
...
local function start_pomodoro()
	...
	require("pomodoro-nvim.messages").show_message_1()

	timer_id = vim.fn.timer_start(pomodoro_settings.work_duration * 60 * 1000, function()
		vim.fn.timer_stop(timer_id)
		require("pomodoro-nvim.messages").show_message_2()

		vim.fn.timer_start(pomodoro_settings.break_duration * 60 * 1000, function()
